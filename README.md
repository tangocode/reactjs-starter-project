# Tangocode Documentation #
This is a ReactJS Typescript project created with create-react-app. This project includes the dependencies that we want to share accross the company and the best practices that we have discovered they help us to write better ReactJS applications. 

**IMPORTAN** - Before using the project. Please follow the guide for [Updating to New Releases](#updating-to-new-releases) of create-react-app.

## Functionalities included
The idea of having a Tangocode starter project is to reuse functionalities that usually all our applications neet to have. This is a list of such functionalities:

- Authentication integrated with Redux and Sagas
- Routes management with react-router v4



## Dependencies used at Tangocode
